...
"")
        ...
        self.gridLayout_9.addWidget(self.pushButton_4, 4, 0, 1, 1)
        ...
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.gridLayout_9.addWidget(self.comboBox, 3, 0, 1, 1)
...
"border-radius:30px")
        ...
        self.webEngineView.setUrl(QtCore.QUrl("https://www.google.com/maps/@31.5833248,74.4173763,15z"))
        self.webEngineView.setObjectName("webEngineView")
        self.gridLayout_10.addWidget(self.webEngineView, 0, 0, 1, 1)
        self.gridLayout_7.addWidget(self.frame_5, 4, 0, 1, 2)
        ...
        self.frame_3.setStyleSheet("background-color: rgb(204, 204, 204);")
        ...
        self.gridLayout_7.addWidget(self.frame_3, 6, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_13, 3, 2, 1, 1)
...
"background-color: rgb(204, 204, 204);")
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget.addItem(item)
        self.gridLayout_7.addWidget(self.listWidget, 4, 2, 3, 3)
        ...
        self.gridLayout_7.addWidget(self.label_15, 5, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pushButton_3, 3, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setStyleSheet(_translate("MainWindow", "background: None"))
        self.label_7.setText(_translate("MainWindow", "Address"))
        self.label_5.setText(_translate("MainWindow", "Restaurant name"))
        self.label_6.setStyleSheet(_translate("MainWindow", "background: None"))
        self.label_6.setText(_translate("MainWindow", "Restaurant_ID"))
        self.label_10.setStyleSheet(_translate("MainWindow", "background: None"))
        self.label_10.setText(_translate("MainWindow", "locality"))
        self.label_12.setStyleSheet(_translate("MainWindow", "background: None"))
        self.label_12.setText(_translate("MainWindow", "Currency"))
        self.label_8.setStyleSheet(_translate("MainWindow", "background: None"))
        self.label_8.setText(_translate("MainWindow", "City"))
        self.label_11.setStyleSheet(_translate("MainWindow", "background: None"))
